  ...
  return (
    ...
    >
      ...
      <div className="aspect-square bg-background-secondary flex items-center justify-center relative">
        ...
        {/* Condition badge */}
        <span className={`absolute bottom-2 left-2 text-xs font-medium px-2 py-0.5 rounded-md ${CONDITION_COLORS[product.condition] ?? "bg-border text-foreground"}`}>
        ...
        >
          <Heart size={15} className={liked ? "fill-red-500 text-red-500" : "text-foreground-secondary"} strokeWidth={2} />
        </button>
      </div>
