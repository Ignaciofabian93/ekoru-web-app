...
export default function ServiceProviderCard(seller: Seller) {
  ...
  return (
    <div className="w-80 shrink-0">
      <div className="flex w-full h-42 items-stretch rounded-2xl bg-white shadow-md overflow-hidden cursor-pointer">
        ...
        <figure className="relative w-30 shrink-0 bg-linear-to-br from-amber-800 to-amber-500 flex flex-col items-center justify-evenly overflow-hidden">
          {/* Decorative dots */}
          ...
          {/* Verified pill */}
          {isVerified && (
            <div className="mx-auto w-fit flex items-center gap-1 bg-white text-amber-700 text-[11px] font-semibold px-2.5 py-1 rounded-full shadow-md">
