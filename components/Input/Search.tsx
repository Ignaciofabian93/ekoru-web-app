...
import { Search as SearchIcon, X, type LucideIcon } from "lucide-react";
      ...
      <div className={clsx("relative flex flex-col gap-px", WIDTH_CLASS[width])}>
        ...
        <div className={clsx("group relative flex items-center", s.h)}>
          ...
          <input
            ...
            className={clsx(
              "box-border h-full w-full rounded-md border-2 border-solid font-sans font-normal text-input-text outline-none transition-[border-color,background-color] duration-150 [&::-webkit-search-cancel-button]:appearance-none",
              s.text,
              s.px,
              s.padLeft,
